...
//     try {
//       const response = await fetch(`${process.env.NEXT_PUBLIC_WEBSITE_URL}api/main-image`, {
//         method: "POST",
//         body: formData,
//       });
...
const AddNewProduct = () => {
  ...
  const addProduct = async () => {
    ...
    const requestOptions: any = {
      ...
      body: JSON.stringify({
        ...product,
        additionalImages: imageUrls, // Include additional images in the product data
      }),
    };
    ...
    fetch(`${process.env.NEXT_PUBLIC_WEBSITE_URL}/api/products`, requestOptions)
      ...
      .then((data) => {
        ...
        setProduct({
          ...
          manufacturer: "",
          inStock: 1,
          mainImage: "", // Reset main image
          description: "",
          slug: "",
          categoryId: "",
        });
        setAdditionalImages([]); // Clear additional images
      })
      .catch((error) => {
        toast.error("There was an error while creating product");
      });
  ...
  const handleUpload = async () => {
    ...
    const response = await fetch(`${process.env.NEXT_PUBLIC_WEBSITE_URL}/api/products_images`, {
      method: 'POST',
      body: formData,
    });
    ...
    const data = await response.json();
    return data.urls; // Return the uploaded image URLs
  };
